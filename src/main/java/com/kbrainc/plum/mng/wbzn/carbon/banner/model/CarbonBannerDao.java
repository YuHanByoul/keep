package com.kbrainc.plum.mng.wbzn.carbon.banner.model;
...
*
* <pre>
* com.kbrainc.plum.mng.wbzn.carbon.banner.model
* - CarbonBannerDao.java
* </pre>
*
* @ClassName : CarbonBannerDao
* @Description : 탄소중립환경교육 -> 배너관리 Dao
* @author : JD
* @date : 2022. 12. 29.
* @Version :
...
*/
@Mapper
public interface CarbonBannerDao {
