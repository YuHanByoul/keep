...
import com.kbrainc.plum.front.pop.model.PopDao;
	...
	public List<PopUpNtcVo> getDataForCommnonPopup(PopUpNtcVo paramVO, @UserInfo UserVo user) throws Exception {
		...
		if (list.size() > 0) {
			for (int i = 0; i < list.size(); i++) {
				...
				if(list.get(i).getNtcTrgtRoleid() != null || list.get(i).getNtcTrgtCd().equals("R") ) {
