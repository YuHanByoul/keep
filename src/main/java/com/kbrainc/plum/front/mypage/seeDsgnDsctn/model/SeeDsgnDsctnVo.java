...
* </pre>
*
* @ClassName : SeeDsgnDsctnVo
* @Description : 사회환경교육기관 지정 관리 > 지정관리 vo
* @author : LHM
* @date : 2023. 4. 25.
* @Version :
...
*/
@Data
@Alias("front.SeeDsgnDsctnVo")
public class SeeDsgnDsctnVo extends ParentRequestVo {
