...
/**
* 사회환경교육기관 지정 관리 > 지정관리 service
*
* <pre>
* com.kbrainc.plum.front.mypage.seeDsgnDsctn.service
* - SeeDsgnDsctnService.java
* </pre>
*
* @ClassName : SeeDsgnDsctnService
* @Description : 사회환경교육기관 지정 관리 > 지정관리 service
* @author : LHM
* @date : 2023. 4. 25.
* @Version :
* @Company : CopyrightⒸ KBRAIN Company. All Rights Reserved
*/
public interface SeeDsgnDsctnService {
