...
public class SecurityPropertiesImpl implements SecurityProperties {
	...
	private final String DEF_USER_LOGIN_INFO_QUERY = 
			"  SELECT  A.USERID, A.NM, A.PSWD, A.INSTID, A.INSTPIC_ROLE_CD, A.ACNT_LOCK_YN, A.ACNT_LOCK_CD, A.PRVC_VLDTY, D.REG_DT, A.PSWD_MDFCN_DT, A.LGN_FAIL_CNT, B.APRV_STTS_CD AS INST_APRV_STTS_CD, B.USE_YN AS INST_USE_YN, "
